...
public class EqualOverrideNoHashcodeOverride {
...
//if we add objects to Map then any update to Object i.e. Key itself still retrieves correct Value since hashcode is still same !
        ...
        System.out.println("s1.hashCode() = " + s1.hashCode()); //hashcode is still same using Object class native hashcode()
        ...
        System.out.println("new Student(\"Michael\",\"Cen\").hashCode() = " + new Student("Michael", "Cen",101).hashCode());
        System.out.println("Marks of Student s1 is: "+ map.get(new Student("Michael","Cen",101))); //returns null
