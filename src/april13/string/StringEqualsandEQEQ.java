...
public class StringEqualsandEQEQ {
    ...
    public static void main(String[] args) {
        ...
        String s4 = new String("test");     //creates a new object in Heap. this is different than "test" already present
...
//        "==" checks if points to same reference (and not content)
        ...
        System.out.println(s3==s4);     //s3/s4 do not point to the same "test" in heap, hence false
